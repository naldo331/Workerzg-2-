...
export default function NavBar() {
  ...
  const getDashboardLink = () => {
    ...
    if (userProfile.role === 'worker') return '/worker/dashboard';
          ...
          <div className="hidden md:flex items-center space-x-6">
            {!currentUser ? (
              ...
              <div className="flex items-center space-x-4">
                <Link to={getDashboardLink()} className="text-sm font-medium text-zinc-300 hover:text-yellow-400 transition-colors flex items-center gap-1">
              ...
              {!currentUser ? (
                ...
                <>
                  <Link 
                    to={getDashboardLink()} 
                    onClick={() => setIsMenuOpen(false)}
                    className="block px-3 py-2 text-base font-medium text-zinc-300 hover:bg-zinc-900 hover:text-yellow-400 rounded-md flex items-center gap-2"
                  >
                    <UserCircle className="w-5 h-5" />
                    Dashboard
                  </Link>
